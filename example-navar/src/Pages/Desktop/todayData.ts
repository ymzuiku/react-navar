import { navarManager } from '../../navar';
...
export const todayData = [
  {
    ...
    很久就听过她的大名，但真正玩到却是今天，玩了7个小时，打到十一章，非常软皮模式，打的就很舒服2333

游戏非常的瑟琴，是个披着格斗游戏的黄油游戏，完全服务男性玩家！但我这样的女性玩家也沉迷与她的性格、声音和美色不能自拔，在她各种卖骚的镜头里，不仅由心底发出了想和她结婚或者做同床密友的想法！而在瑟琴中又包含着一点沙雕和可爱（指小女孩）。感觉剧情部分要多于游戏部分，有一瞬间觉得这其实是个文字游戏吧，之后想想才发现自己难度太低了。

在游戏里可以上天入地开车带孩子，但最有趣的还是看贝姐的各种处（s）决（m）技，我tm看爆——剑阁纹灵`,
  },
  {
    dark: true,
    info: '指南',
